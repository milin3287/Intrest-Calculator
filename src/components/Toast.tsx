...
export const Toast: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-20 md:bottom-6 right-4 sm:right-6 z-50 transition-all duration-300 pointer-events-none animate-in fade-in slide-in-from-bottom-5 max-w-[calc(100vw-2rem)]">
